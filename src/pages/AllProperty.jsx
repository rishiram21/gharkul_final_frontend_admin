...
import { Search, Filter, Plus, Eye, Building, MapPin, Calendar, User } from 'lucide-react';
            ...
            <div className="flex items-center space-x-4">
              {/* <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-8 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none bg-white appearance-none cursor-pointer"
                >
