...
import { Home, FileText, Settings, Package, Users, UserCheck, TrendingUp, Bell, Search, User } from 'lucide-react';
                ...
                <div className="relative p-6">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="w-full bg-purple-100 rounded-full h-2">
                      <div className={`h-2 rounded-full bg-gradient-to-r ${item.gradient} transition-all duration-300 group-hover:shadow-lg`} style={{width: '78%'}}></div>
                    </div>
                  </div>
                </div>
